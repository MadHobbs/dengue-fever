...
Using the same method, we constructed a time series random forest model, using time as a predictor and included the time lags created above. We use only 100 trees per forest, because runtime is otherwise a nightmare. We assessed our model as they did: 
