...
In the end, we get n - 30 predictions for dengue cases in a week (we ge predictions o for )

,  by taking data from the previous 30 weeks to predict for the next week. The simulation steps forward iteratively adding new data for each week, the new model using the updated data to predict the next week, and comparing to the true number of cases.
